...
class MailFragment: BaseFragment<FragmentHistoryMailBinding>(FragmentHistoryMailBinding::inflate) {

    val items = List(100, {i -> History(i,"3부족하면 부족한대로 채우고 충분하면 충분한대로 매력 발산하면서 멋지게 살자." +
    ...
    override fun initAfterBinding() {
        ...
        binding.fragmentMailRv.adapter = recyclerViewAdapter
        binding.fragmentMailRv.layoutManager = LinearLayoutManager(context,
        ...
        recyclerViewAdapter.setMyItemClickListener(object : NoSenderRecyclerViewAdapter.MyItemClickListener{
            override fun MoveToDetail(historyIdx: Int) {
                mActivity.let {
                    ...
                    val bundle = bundleOf("backPos" to "historymail")
