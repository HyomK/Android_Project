...
import com.likefirst.btos.data.remote.plant.viewmodel.PlantInfoViewModel
...
class LoginActivity
    ...
    private val DEFAULT_WEB_CLIENT_KEY = BuildConfig.default_notification_channel_id

    lateinit var plantModel : PlantViewModel
    val  viewModel by viewModels<PlantInfoViewModel>()
    ...
    fun updatePlantDB(){
        ...
        val result = viewModel.getPlantList()
    ...
    override fun onPlantListSuccess(plantList: ArrayList<Plant>) {
        ...
        plantList.forEach { i ->
            run {
                if ( viewModel.getPlant(i.plantIdx) == null) {
                    ...
                    viewModel.setInitPlant(i.plantIdx,i.plantStatus,i.currentLevel,i.isOwn)
                }
            }
        }  // 전
    }
